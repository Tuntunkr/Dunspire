        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="prose prose-gray max-w-none">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Website Development Services</h2>
                <div className="mb-6">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">App Development Services</h2>
                <div className="mb-6">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">SEO & Digital Marketing Services</h2>
                <div className="mb-6">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    If you don't see measurable improvement in your SEO rankings or digital marketing metrics within 90 days, we'll provide an additional 30 days of service at no charge or offer a partial refund.
                  </p>
                </div>
              </section>

              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">UI/UX & Creative Design Services</h2>
                <ul className="list-disc list-inside text-gray-700 space-y-2">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">AI & Automation Services</h2>
                <ul className="list-disc list-inside text-gray-700 space-y-2">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Cloud & Tech Solutions</h2>
                <ul className="list-disc list-inside text-gray-700 space-y-2">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Refund & Cancellation Process</h2>
                <div className="mb-4">
              ...
              <section className="mb-8">
                ...
                <div className="mt-4 text-gray-700 bg-gray-50 p-6 rounded-lg">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  This policy may be updated from time to time. Clients will be notified of any significant changes via email. Continued use of our services after policy updates constitutes acceptance of the new terms.
                </p>
              </section>
            </div>
          </div>
