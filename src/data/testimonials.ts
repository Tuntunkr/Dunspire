...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    rating: 5,
    comment: 'Their SEO and digital marketing services helped us achieve first-page rankings on Google. Our website traffic increased by 300% within 6 months. Excellent ROI on our investment!',
  ...
  },
  {
    ...
    rating: 5,
    comment: 'Their cloud migration services were flawless. Our infrastructure is now more scalable and secure. The team provided excellent support throughout the entire process.',
